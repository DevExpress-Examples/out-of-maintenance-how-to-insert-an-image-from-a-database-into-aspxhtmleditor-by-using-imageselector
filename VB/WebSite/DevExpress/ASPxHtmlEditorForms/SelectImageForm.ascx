<%@ Control Language="vb" AutoEventWireup="true" CodeFile="SelectImageForm.ascx.vb"
			...
			<table cellpadding="0" cellspacing="0" id="dxSelectImageForm">
				<tr>
					<td>
						...
						<dx:HtmlEditorFileManager ID="FileManager" runat="server" DataSourceID="XpoDataSource1"
							Height="500px" Width="800px" ClientInstanceName="FileManager" OnCustomJSProperties="FileManager_CustomJSProperties"
							Border-BorderStyle="None">
							<ClientSideEvents SelectedFileChanged="aspxHESelectImageForm_OnSelectedFileChanged"
								SelectedFileOpened="aspxHESelectImageForm_ImageSelected" />
							<Styles>
							...
							<SettingsDataSource KeyFieldName="Id" ParentKeyFieldName="Pid" NameFieldName="Name"
							...
							<Settings ThumbnailFolder="~/FileManager/Thumbnails" />
						</dx:HtmlEditorFileManager>
						<dx:XpoDataSource ID="XpoDataSource1" runat="server" TypeName="PersistentObjects.ArtsEntity">
						</dx:XpoDataSource>
					</td>
				</tr>
				<tr>
